...
public class Stream_06_Test {
	...
	public void test_sumWithAccumulatorParallel() throws Exception {
		...
		Stream.of(1L, 2L, 3L, 10L, 20L, 50L, 1000L, 100000L).forEach(n -> {
			...
			// On constate que la méthode add de la classe Accumulator n'est pas "thread
			// safe".
			// Pour cela il faut faire l'addition avec l'instance de Accumulator en
			// commentaires et qui utilise AtomicLong.
